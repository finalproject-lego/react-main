...
function Notice() {
	...
	const getBbsList = async (choice, search, page) => {
		...
		await axios.get("http://localhost:3000/noticelist", { params: { "choice": choice, "search": search, "page": page } })
			.then((resp) => {
	...
	return (
		...
		<div>
			...
			<div className="my-5 d-flex justify-content-center">
				<Link className="btn btn-outline-secondary" to="/noticewrite"><i className="fas fa-pen"></i> &nbsp; 글등록</Link>
			</div>
